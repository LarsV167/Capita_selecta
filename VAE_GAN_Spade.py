...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.out=nn.Sequential(nn.Flatten(1),nn.Linear(256*8*8,1),
            nn.Sigmoid(),
        )  
    ...
    def forward(self, img, seg): #input real or fake image and label 
        ...
        x=x.view(-1,256*8*8) #In case of dense layer change shape of x to fit in Linear function to output 1 channel
